...
parser.add_argument('--dataset_train',type=str,default='../datasets/QB/train')
parser.add_argument('--dataset_val',type=str,default='../datasets/QB/val')
parser.add_argument('--dataset_test', type=str, default='../datasets/QB/test')
# parser.add_argument('-threads',type=int,default=4,help='number of threads for data loader to use')
# parser.add_argument('--batchSize',type=int,default=64,help='training batch size')
parser.add_argument('--batchSize',type=int,default=16,help='training batch size')
parser.add_argument('--net',type=str,default='DMF_Net',help='network')
